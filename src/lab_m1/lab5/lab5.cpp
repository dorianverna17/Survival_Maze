...
void Lab5::Update(float deltaTimeSeconds)
{
    ...
    {
        glm::mat4 modelMatrix = glm::mat4(1);
        modelMatrix = glm::translate(modelMatrix, glm::vec3(4.0f, 4.0f, 2.0f));
        modelMatrix = glm::rotate(modelMatrix, RADIANS(120.f), glm::vec3(1.0f, 1.0f, 0.0f));
...

    {
        ...
        modelMatrix = glm::rotate(modelMatrix, RADIANS(180.f), glm::vec3(0.0f, 1.0f, 0.0f));
...
void Lab5::OnInputUpdate(float deltaTime, int mods)
{
    ...
    float cameraSpeed_aux = 2.0f;

    if (window->KeyHold(GLFW_KEY_U))
    {
        fov += deltaTime * cameraSpeed_aux;
